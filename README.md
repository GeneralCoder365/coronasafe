...
v3 of the app is currently being worked on, and we're expanding our operations. Coming soon is a server hosting backend, our very own website, and support for more platforms (desktop, iOS/Android)!
...
SSL is imported to connect plotly with the CSV files through this code: `ssl._create_default_https_context = ssl._create_unverified_context`
...
Contains places search function, master risk calculation algorithm, and COVID case maps constructor caller. Calls:
